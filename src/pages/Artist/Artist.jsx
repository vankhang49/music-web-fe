...
export function Artist() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            await getArtistByName(artistName);
        }
        fetchData();
    }, [artistName]);

    const getArtistByName = async (artistName) => {
        const temp = await artistService.getArtistByArtistName(artistName);
        setArtist(temp);
    }
                ...
                <Card shape={'circle'}
                      ...
                      description={
                          <Flex justifyContent={'start'} alignItems={'center'}>
                              <Typography tag={'span'}>1.000.000 người quan tâm</Typography>
                    ...
                    <Flex justifyContent={'start'} alignItems={'start'} flexWrap={'wrap'}>
                        ...
                        <Group className={'biography'} gd={{ width: '50%'}}>
                            ...
                            <Flex className={'follow-award'} justifyContent={'start'}>
                                <Group gd={{width: "30%"}}>
                                    <Typography tag={'h3'}>1.000.000</Typography>
                                    <Typography tag={'span'}>Người quan tâm</Typography>
                                </Group>
